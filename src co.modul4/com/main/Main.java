...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < kendaraan.length; i++) {
            ...
            System.out.printf("Masukkan model kendaraan ke-%d :", (i + 2));
            kendaraan[i].setModel(input.next());
            System.out.printf("Masukkan warna kendaraan ke-%d :", (i + 3));
            kendaraan[i].setWarna(input.next());
            System.out.printf("Masukkan tahun kendaraan ke-%d :", (i + 4));
